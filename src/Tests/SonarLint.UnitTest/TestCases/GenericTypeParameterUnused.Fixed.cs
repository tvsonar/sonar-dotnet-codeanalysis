...
namespace Tests.Diagnostics
{
    ...
    public class MoreMath // Noncompliant; <T> is ignored
    {
        public int Add(int a, int b) // Noncompliant; <T> is ignored
        {
            return a + b;
        }
    }
    ...
    public class MoreMath4<T> : MoreMath2<T> // Noncompliant
    {
    }
    ...
    public class MoreMath5<T, T3> : MoreMath2<Dictionary<string, List<T>>>
    {
        ...
        public T3 DoStuff<T3>(params T3[] o) // Noncompliant
        {
            return o[0];
        }
    }
